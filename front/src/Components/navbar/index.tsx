...
export const NavBar: React.FC<Token> = ({ token }) => {
          ...
          {!token ? (
            <div className="absolute inset-y-0 right-0 flex items-center space-x-4 pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
              ...
              <button
                ...
                type="button"
                className="rounded-md bg-lime-600 px-4 py-2 text-sm font-medium text-white hover:bg-lime-500 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
              >
                Register
              </button>
            </div>
